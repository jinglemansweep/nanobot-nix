...
- [x] **Add Zhipu integration test to `tests/test_config_generate.py`** — Add a new test function `test_generate_zhipu_provider` to `tests/test_config_generate.py`, following the pattern of the existing `test_generate_full_pipeline` test (lines 126–148). The test should:
